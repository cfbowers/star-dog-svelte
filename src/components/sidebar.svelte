<script lang="ts">
	...
	import CompanyLogo from '../tenant/company-logo.svelte';
	...
	const navItems = [
		{ href: '/check-ins', iconClass: 'fa-check', label: 'Check Ins' },
		{ href: '/dogs', iconClass: 'fa-paw', label: 'Dogs' },
		{ href: '/members', iconClass: 'fa-user-group', label: 'Members' },
		{ href: '/dog-houses', iconClass: 'fa-house', label: 'Dog Houses' }
	];
</script>

<div class="flex flex-col w-64 min-h-full gap-y-5 overflow-y-auto bg-gray-900">
	...
	<nav class="flex flex-1 flex-col px-4">
		<ul role="list" class="flex flex-1 flex-col gap-y-7">
			...
			<li class="mt-auto mb-3">
				<NavItem href="/profile" label="Profile" isActive={$page.url.pathname === '/profile'}>
